...
# local imports
from odysseydebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a odysseyd debug node on an existing chain, trigger a hardfork' \
...
def run_odysseyd_tests( debug_node ):
   from odysseyapi.odysseynoderpc import OdysseyNodeRPC
   ...
   try:
      ...
      rpc = OdysseyNodeRPC( 'ws://127.0.0.1:8095', '', '' )
      ...
      print( "account, curation_odyssey" )
