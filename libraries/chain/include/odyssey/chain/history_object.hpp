...
FC_REFLECT( odyssey::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::operation_object, odyssey::chain::operation_index )

FC_REFLECT( odyssey::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::account_history_object, odyssey::chain::account_history_index )
