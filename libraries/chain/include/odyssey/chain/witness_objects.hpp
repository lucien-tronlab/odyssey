...
namespace odyssey { namespace chain {
   ...
   using odyssey::protocol::chain_properties;
   using odyssey::protocol::digest_type;
   using odyssey::protocol::public_key_type;
   using odyssey::protocol::version;
   using odyssey::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Odyssey blockchain version the witness is running.
          */
         version           running_version;

         hardfork_version  hardfork_version_vote;
         time_point_sec    hardfork_time_vote = ODYSSEY_GENESIS_TIME;
   };
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, ODYSSEY_MAX_WITNESSES >             current_shuffled_witnesses;
         ...
         uint8_t max_voted_witnesses            = ODYSSEY_MAX_VOTED_WITNESSES_HF0;
         uint8_t max_miner_witnesses            = ODYSSEY_MAX_MINER_WITNESSES_HF0;
         uint8_t max_runner_witnesses           = ODYSSEY_MAX_RUNNER_WITNESSES_HF0;
         uint8_t hardfork_required_witnesses    = ODYSSEY_HARDFORK_REQUIRED_WITNESSES;
   };
...
FC_REFLECT_ENUM( odyssey::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( odyssey::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::witness_object, odyssey::chain::witness_index )

FC_REFLECT( odyssey::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::witness_vote_object, odyssey::chain::witness_vote_index )

FC_REFLECT( odyssey::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::witness_schedule_object, odyssey::chain::witness_schedule_index )
