...
FC_REFLECT( odyssey::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::transaction_object, odyssey::chain::transaction_index )
