...
FC_REFLECT( odyssey::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::block_summary_object, odyssey::chain::block_summary_index )
