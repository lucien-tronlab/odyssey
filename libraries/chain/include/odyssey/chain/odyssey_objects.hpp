...
namespace odyssey { namespace chain {
   ...
   using odyssey::protocol::asset_symbol_type;

   typedef protocol::fixed_string_16 reward_fund_name_type;

   /**
    *  This object is used to track pending requests to convert sbd to odyssey
    */
    ...
    *  1000 ODYSSEY or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         {
            return odyssey_volume * sbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(odyssey_volume,sbd_volume) * is_positive();
         }
         ...
         {
            return ( odyssey_volume > 0 && sbd_volume > 0 ) ? 1 : 0;
         }
   };
...
#include <odyssey/chain/comment_object.hpp>
#include <odyssey/chain/account_object.hpp>

FC_REFLECT_ENUM( odyssey::chain::curve_id,
                  (quadratic)(quadratic_curation)(linear)(square_root))

FC_REFLECT( odyssey::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::limit_order_object, odyssey::chain::limit_order_index )

FC_REFLECT( odyssey::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::feed_history_object, odyssey::chain::feed_history_index )

FC_REFLECT( odyssey::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::convert_request_object, odyssey::chain::convert_request_index )

FC_REFLECT( odyssey::chain::liquidity_reward_balance_object,
             (id)(owner)(odyssey_volume)(sbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::liquidity_reward_balance_object, odyssey::chain::liquidity_reward_balance_index )

FC_REFLECT( odyssey::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::withdraw_vesting_route_object, odyssey::chain::withdraw_vesting_route_index )

FC_REFLECT( odyssey::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::savings_withdraw_object, odyssey::chain::savings_withdraw_index )

FC_REFLECT( odyssey::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (sbd_balance)(odyssey_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::escrow_object, odyssey::chain::escrow_index )

FC_REFLECT( odyssey::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::decline_voting_rights_request_object, odyssey::chain::decline_voting_rights_request_index )

FC_REFLECT( odyssey::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::reward_fund_object, odyssey::chain::reward_fund_index )
