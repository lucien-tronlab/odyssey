...
FC_REFLECT( odyssey::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::comment_object, odyssey::chain::comment_index )

FC_REFLECT( odyssey::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::comment_vote_object, odyssey::chain::comment_vote_index )
