...
#include <odyssey/protocol/authority.hpp>
...
#include <odyssey/chain/shared_authority.hpp>
...
namespace odyssey { namespace chain {
   ...
   using odyssey::protocol::authority;
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = ODYSSEY_NULL_ACCOUNT;
         ...
         bool              can_vote = true;
         uint16_t          voting_power = ODYSSEY_100_PERCENT;   ///< current voting power of this account, it falls after every vote
         time_point_sec    last_vote_time; ///< used to increase the voting power of this account the longer it goes without voting.

         asset             balance = asset( 0, ODYSSEY_SYMBOL );  ///< total liquid shares held by this account
         asset             savings_balance = asset( 0, ODYSSEY_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  ODYSSEY_MIN_COMPOUNDING_INTERVAL_SECONDS has past since sbd_last_interest_payment then
         ...
         asset             reward_odyssey_balance = asset( 0, ODYSSEY_SYMBOL );
         asset             reward_vesting_balance = asset( 0, VESTS_SYMBOL );
         asset             reward_vesting_odyssey = asset( 0, ODYSSEY_SYMBOL );
         ...
         fc::array<share_type, ODYSSEY_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( ODYSSEY_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         >,
         ordered_unique< tag< by_odyssey_balance >,
            composite_key< account_object,
...
FC_REFLECT( odyssey::chain::account_object,
             ...
             (reward_odyssey_balance)(reward_sbd_balance)(reward_vesting_balance)(reward_vesting_odyssey)
...
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::account_object, odyssey::chain::account_index )

FC_REFLECT( odyssey::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::account_authority_object, odyssey::chain::account_authority_index )

FC_REFLECT( odyssey::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::vesting_delegation_object, odyssey::chain::vesting_delegation_index )

FC_REFLECT( odyssey::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::vesting_delegation_expiration_object, odyssey::chain::vesting_delegation_expiration_index )

FC_REFLECT( odyssey::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::owner_authority_history_object, odyssey::chain::owner_authority_history_index )

FC_REFLECT( odyssey::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::account_recovery_request_object, odyssey::chain::account_recovery_request_index )

FC_REFLECT( odyssey::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( odyssey::chain::change_recovery_account_request_object, odyssey::chain::change_recovery_account_request_index )
