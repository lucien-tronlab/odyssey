...
namespace odyssey { namespace chain {
   ...
   using odyssey::protocol::weight_type;
...
FC_REFLECT_TYPENAME( odyssey::chain::shared_authority::account_authority_map)
FC_REFLECT( odyssey::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
