...
template< typename OperationType=odyssey::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=odyssey::protocol::operation >
...
class X ## _evaluator : public odyssey::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : odyssey::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
