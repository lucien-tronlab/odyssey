...
namespace odyssey { namespace sidechain {
  using std::string;
...
#define side_ids 10
  ...
  FC_REFLECT_DERIVED( odyssey::sidechain::side_account, (graphene::db::object),
                      (sidechain)(name)(odyssey_balance)(dollar_balance)
                     );
