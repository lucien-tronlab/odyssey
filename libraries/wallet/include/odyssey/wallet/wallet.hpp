...
#include <odyssey/app/api.hpp>
#include <odyssey/private_message/private_message_plugin.hpp>
#include <odyssey/follow/follow_plugin.hpp>
#include <odyssey/app/odyssey_api_objects.hpp>
...
using namespace odyssey::app;
using namespace odyssey::chain;
using namespace graphene::utilities;
using namespace std;

namespace odyssey { namespace wallet {

using odyssey::app::discussion;
using namespace odyssey::private_message;
...
class wallet_api
{
   public:
       ...
       *  'info' wallet command.
       *
       *  These accounts are created with combination of ODYSSEY and delegated SP
       *
       *  @param creator The account creating the new account
       *  @param odyssey_fee The amount of the fee to be paid with ODYSSEY
       *  @param delegated_vests The amount of the fee to be paid with delegation
       *  @param new_account_name The name of the new account
       *  @param json_meta JSON Metadata associated with the new account
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction create_account_delegated( string creator, asset odyssey_fee, asset delegated_vests, string new_account_name, string json_meta, bool broadcast );
      ...
      /**
       * Transfer funds from one account to another. ODYSSEY and SBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param amount The funds being transferred. i.e. "100.000 ODYSSEY"
      ...
      /**
       * Transfer funds from one account to another using escrow. ODYSSEY and SBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       ...
       * @param odyssey_amount The amount of ODYSSEY to transfer
       ...
       * @param odyssey_amount The amount of ODYSSEY that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       * Transfer ODYSSEY into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of ODYSSEY is vesting.
       *
       * @param from The account the ODYSSEY is coming from
       * @param to The account getting the VESTS
       * @param amount The amount of ODYSSEY to vest i.e. "100.00 ODYSSEY"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *    withdrawn and deposited back as ODYSSEY. i.e. "10.000000 VESTS"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *
       * @param from The account the VESTS are withdrawn from.
       * @param to   The account receiving either VESTS or ODYSSEY.
      ...
      /**
       *  This method will convert SBD to ODYSSEY at the current_median_history price one
      ...
      /**
       * A witness can public a price feed for the ODYSSEY:SBD market. The median price feed is used
       * to process conversion requests from SBD to ODYSSEY.
       *
       ...
       *                       operations defined in `odyssey/chain/operations.hpp`
      ...
      /**
       * Gets the current order book for ODYSSEY:SBD
       *
       ...
       *  @param amount_to_sell The amount of either SBD or ODYSSEY you wish to sell
      ...
      /**
       * Vote on a comment to be paid ODYSSEY
       *
       ...
       * Odyssey Power. Until the challenged proves their active key, all posting rights are revoked.
       *
      ...
      annotated_signed_transaction claim_reward_balance( string account, asset reward_odyssey, asset reward_sbd, asset reward_vests, bool broadcast );
};
...
FC_REFLECT( odyssey::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( odyssey::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( odyssey::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( odyssey::wallet::authority_type, (owner)(active)(posting) )

FC_API( odyssey::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( odyssey::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
