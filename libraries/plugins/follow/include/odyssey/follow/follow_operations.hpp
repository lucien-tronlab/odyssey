...
FC_REFLECT( odyssey::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( odyssey::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( odyssey::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( odyssey::follow::follow_plugin_operation )
