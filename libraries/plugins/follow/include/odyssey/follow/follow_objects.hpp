...
/**
 *  This index is maintained to get an idea of which authors are reodysseyed by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were reodysseyed by this blog
 */
...
FC_REFLECT_ENUM( odyssey::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( odyssey::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( odyssey::follow::follow_object, odyssey::follow::follow_index )

FC_REFLECT( odyssey::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( odyssey::follow::feed_object, odyssey::follow::feed_index )

FC_REFLECT( odyssey::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( odyssey::follow::blog_object, odyssey::follow::blog_index )

FC_REFLECT( odyssey::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( odyssey::follow::reputation_object, odyssey::follow::reputation_index )

FC_REFLECT( odyssey::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( odyssey::follow::follow_count_object, odyssey::follow::follow_count_index )

FC_REFLECT( odyssey::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( odyssey::follow::blog_author_stats_object, odyssey::follow::blog_author_stats_index );
