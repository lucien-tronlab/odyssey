...
#include <odyssey/plugins/block_info/block_info_api.hpp>
#include <odyssey/plugins/block_info/block_info_plugin.hpp>

namespace odyssey { namespace plugin { namespace block_info {
...
{
   public:
      block_info_api_impl( odyssey::app::application& _app );

      std::shared_ptr< odyssey::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( odyssey::app::application& _app ) : app( _app )
{}

std::shared_ptr< odyssey::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const odyssey::app::api_context& ctx )
{
