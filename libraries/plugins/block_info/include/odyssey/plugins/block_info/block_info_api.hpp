...
{
   public:
      block_info_api( const odyssey::app::api_context& ctx );
...
FC_REFLECT( odyssey::plugin::block_info::get_block_info_args,
   (start_block_num)
   (count)
   )

FC_API( odyssey::plugin::block_info::block_info_api,
   (get_block_info)
