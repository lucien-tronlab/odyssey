...
class debug_node_plugin : public odyssey::app::plugin
{
   public:
      ...
      void debug_update( Lambda&& callback, uint32_t skip = odyssey::chain::database::skip_nothing )
      {
      ...
      uint32_t debug_generate_blocks(
         ...
         uint32_t count,
         uint32_t skip = odyssey::chain::database::skip_nothing,
