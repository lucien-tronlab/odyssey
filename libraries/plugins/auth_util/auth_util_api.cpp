...
#include <odyssey/protocol/sign_state.hpp>

#include <odyssey/chain/account_object.hpp>
#include <odyssey/chain/database.hpp>

#include <odyssey/plugins/auth_util/auth_util_api.hpp>
#include <odyssey/plugins/auth_util/auth_util_plugin.hpp>
...
{
   public:
      auth_util_api_impl( odyssey::app::application& _app );
      void check_authority_signature( const check_authority_signature_params& args, check_authority_signature_result& result );

      std::shared_ptr< odyssey::plugin::auth_util::auth_util_plugin > get_plugin();

      odyssey::app::application& app;
};

auth_util_api_impl::auth_util_api_impl( odyssey::app::application& _app ) : app( _app )
{}

std::shared_ptr< odyssey::plugin::auth_util::auth_util_plugin > auth_util_api_impl::get_plugin()
{
...
auth_util_api::auth_util_api( const odyssey::app::api_context& ctx )
{
