...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( odyssey::app::application& app )
            :_app( app ) {}
...
blockchain_statistics_api::blockchain_statistics_api( const odyssey::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->odyssey_transferred                      += b.odyssey_transferred;
   ...
   this->odyssey_vested                           += b.odyssey_vested;
   ...
   this->odyssey_converted                        += b.odyssey_converted;
