...
class blockchain_statistics_plugin : public odyssey::app::plugin
{
   public:
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           odyssey_transferred = 0;                       ///< ODYSSEY transferred from account to account
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of ODYSSEY paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of ODYSSEY into VESTS
   share_type           odyssey_vested = 0;                            ///< Ammount of ODYSSEY vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to ODYSSEY
...
FC_REFLECT( odyssey::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( odyssey::blockchain_statistics::bucket_object, odyssey::blockchain_statistics::bucket_index )
