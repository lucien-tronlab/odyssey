...
#include <odyssey/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const odyssey::app::api_context& ctx );
...
FC_REFLECT( odyssey::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( odyssey::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
