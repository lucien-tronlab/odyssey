...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_odyssey_value = 0;     ///< ODYSSEY Value of author rewards
   ...
   share_type           curation_rewards_odyssey_value = 0;         ///< ODYSSEY Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of ODYSSEY paid as liquidity rewards
   ...
   share_type           odyssey_sent = 0;                           ///< ODYSSEY sent from this account
   share_type           odyssey_received = 0;                       ///< ODYSSEY received by this account
   ...
   share_type           odyssey_vested = 0;                         ///< ODYSSEY vested by the account
   ...
   share_type           odyssey_received_from_withdrawls = 0;       ///< ODYSSEY received from this account's vesting withdrawals
   share_type           odyssey_received_from_routes = 0;           ///< ODYSSEY received from another account's vesting withdrawals
   ...
   share_type           odyssey_converted = 0;                      ///< Amount of ODYSSEY that was converted
   ...
   share_type           limit_order_odyssey_paid = 0;               ///< ODYSSEY paid by limit orders
   share_type           limit_order_odyssey_received = 0;           ///< ODYSSEY received from limit orders
...
class account_statistics_plugin : public odyssey::app::plugin
{
   public:
...
FC_REFLECT( odyssey::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (odyssey_received_from_withdrawls)
   (odyssey_received_from_routes)
   ...
   (limit_order_odyssey_paid)
   (limit_order_odyssey_received)
   (limit_order_sbd_paid)
   (limit_order_sbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( odyssey::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   odyssey::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
