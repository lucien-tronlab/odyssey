...
using odyssey::protocol::fill_order_operation;
      ...
      for( auto bucket : _tracked_buckets )
      {
         ...
         if( itr == bucket_idx.end() )
         {
            db.create< bucket_object >( [&]( bucket_object& b )
            {
               ...
               if( op.open_pays.symbol == ODYSSEY_SYMBOL )
               {
                  b.high_odyssey = op.open_pays.amount;
                  b.high_sbd = op.current_pays.amount;
                  b.low_odyssey = op.open_pays.amount;
                  b.low_sbd = op.current_pays.amount;
                  b.open_odyssey = op.open_pays.amount;
                  b.open_sbd = op.current_pays.amount;
                  b.close_odyssey = op.open_pays.amount;
                  b.close_sbd = op.current_pays.amount;
                  b.odyssey_volume = op.open_pays.amount;
                  b.sbd_volume = op.current_pays.amount;
               }
               else
               {
                  b.high_odyssey = op.current_pays.amount;
                  b.high_sbd = op.open_pays.amount;
                  b.low_odyssey = op.current_pays.amount;
                  b.low_sbd = op.open_pays.amount;
                  b.open_odyssey = op.current_pays.amount;
                  b.open_sbd = op.open_pays.amount;
                  b.close_odyssey = op.current_pays.amount;
                  b.close_sbd = op.open_pays.amount;
                  b.odyssey_volume = op.current_pays.amount;
...
ODYSSEY_DEFINE_PLUGIN( market_history, odyssey::market_history::market_history_plugin )
