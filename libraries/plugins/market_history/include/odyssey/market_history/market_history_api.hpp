...
#include <odyssey/market_history/market_history_plugin.hpp>
...
struct market_ticker
{
   ...
   asset       odyssey_volume = asset( 0 , ODYSSEY_SYMBOL );
...
{
   public:
      market_history_api( const odyssey::app::api_context& ctx );

      void on_api_startup();

      /**
       * @brief Returns the market ticker for the internal SBD:ODYSSEY market
       */
      ...
      /**
       * @brief Returns the current order book for the internal SBD:ODYSSEY market.
      ...
      /**
       * @brief Returns the trade history for the internal SBD:ODYSSEY market.
      ...
      /**
       * @brief Returns the N most recent trades for the internal SBD:ODYSSEY market.
      ...
      /**
       * @brief Returns the market history for the internal SBD:ODYSSEY market.
...
FC_REFLECT( odyssey::market_history::market_ticker,
   (latest)(lowest_ask)(highest_bid)(percent_change)(odyssey_volume)(sbd_volume) );
FC_REFLECT( odyssey::market_history::market_volume,
   (odyssey_volume)(sbd_volume) );
FC_REFLECT( odyssey::market_history::order,
   (price)(odyssey)(sbd) );
FC_REFLECT( odyssey::market_history::order_book,
   (bids)(asks) );
FC_REFLECT( odyssey::market_history::market_trade,
   (date)(current_pays)(open_pays) );

FC_API( odyssey::market_history::market_history_api,
   (get_ticker)
   (get_volume)
   (get_order_book)
   (get_trade_history)
