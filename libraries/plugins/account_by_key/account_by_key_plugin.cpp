#include <odyssey/account_by_key/account_by_key_plugin.hpp>
#include <odyssey/account_by_key/account_by_key_objects.hpp>
...
namespace odyssey { namespace account_by_key {
...
struct post_operation_visitor
{
   ...
   {
      if( op.hardfork_id == ODYSSEY_HARDFORK_0_9 )
      {
...
account_by_key_plugin::account_by_key_plugin( odyssey::app::application* app )
...
} } // odyssey::account_by_key

ODYSSEY_DEFINE_PLUGIN( account_by_key, odyssey::account_by_key::account_by_key_plugin )
