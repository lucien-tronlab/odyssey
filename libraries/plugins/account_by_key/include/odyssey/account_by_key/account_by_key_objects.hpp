...
FC_REFLECT( odyssey::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( odyssey::account_by_key::key_lookup_object, odyssey::account_by_key::key_lookup_index )
