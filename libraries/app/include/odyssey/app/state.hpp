#pragma once
#include <odyssey/app/applied_operation.hpp>
...
namespace odyssey { namespace app {
   ...
   struct extended_account : public account_api_obj
   {
      ...
      asset                                   vesting_balance; /// convert vesting_shares to vesting odyssey
      share_type                              reputation = 0;
...
FC_REFLECT_DERIVED( odyssey::app::extended_account,
                   (odyssey::app::account_api_obj),
...
FC_REFLECT( odyssey::app::vote_state, (voter)(weight)(rshares)(percent)(reputation)(time) );
FC_REFLECT( odyssey::app::account_vote, (authorperm)(weight)(rshares)(percent)(time) );

FC_REFLECT( odyssey::app::discussion_index, (category)(trending)(payout)(payout_comments)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout) )
FC_REFLECT( odyssey::app::tag_index, (trending) )
FC_REFLECT_DERIVED( odyssey::app::discussion, (odyssey::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )

FC_REFLECT( odyssey::app::state, (current_route)(props)(tag_idx)(tags)(content)(accounts)(pow_queue)(witnesses)(discussion_idx)(witness_schedule)(feed_price)(error)(market_data) )

FC_REFLECT_DERIVED( odyssey::app::extended_limit_order, (odyssey::app::limit_order_api_obj), (real_price)(rewarded) )
FC_REFLECT( odyssey::app::order_history_item, (time)(type)(sbd_quantity)(odyssey_quantity)(real_price) );
FC_REFLECT( odyssey::app::market, (bids)(asks)(history)(price_history)(available_candlesticks)(available_zoom)(current_candlestick)(current_zoom) )
FC_REFLECT( odyssey::app::candle_stick, (open_time)(period)(high)(low)(open)(close)(odyssey_volume)(dollar_volume) );
