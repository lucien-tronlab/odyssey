...
using namespace odyssey::protocol;
using namespace std;

struct order
{
   price                order_price;
   double               real_price; // dollars per odyssey
   share_type           odyssey;
   share_type           sbd;
...
{
   public:
      database_api(const odyssey::app::api_context& ctx);
      ~database_api();
      ...
      /**
       * @breif Gets the current order book for TRX:SBD market
...
FC_REFLECT( odyssey::app::order, (order_price)(real_price)(odyssey)(sbd)(created) );
FC_REFLECT( odyssey::app::order_book, (asks)(bids) );
FC_REFLECT( odyssey::app::scheduled_hardfork, (hf_version)(live_time) );
FC_REFLECT( odyssey::app::liquidity_balance, (account)(weight) );
FC_REFLECT( odyssey::app::withdraw_route, (from_account)(to_account)(percent)(auto_vest) );

FC_REFLECT( odyssey::app::discussion_query, (tag)(filter_tags)(select_tags)(select_authors)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit) );

FC_REFLECT_ENUM( odyssey::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_API(odyssey::app::database_api,
   // Subscriptions
