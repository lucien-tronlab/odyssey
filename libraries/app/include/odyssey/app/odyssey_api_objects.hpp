...
#include <odyssey/tags/tags_plugin.hpp>
...
struct comment_api_obj
{
   comment_api_obj( const chain::comment_object& o ):
      ...
      percent_odyssey_dollars( o.percent_odyssey_dollars ),
   ...
   uint16_t          percent_odyssey_dollars = 0;
...
struct account_api_obj
{
   account_api_obj( const chain::account_object& a, const chain::database& db ) :
      ...
      reward_odyssey_balance( a.reward_odyssey_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_odyssey( a.reward_vesting_odyssey ),
   ...
   asset             reward_odyssey_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_odyssey;
...
FC_REFLECT( odyssey::app::comment_api_obj,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_odyssey_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( odyssey::app::account_api_obj,
             ...
             (reward_sbd_balance)(reward_odyssey_balance)(reward_vesting_balance)(reward_vesting_odyssey)
...
FC_REFLECT( odyssey::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( odyssey::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( odyssey::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( odyssey::app::feed_history_api_obj,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( odyssey::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( odyssey::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( odyssey::app::signed_block_api_obj, (odyssey::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( odyssey::app::dynamic_global_property_api_obj, (odyssey::chain::dynamic_global_property_object),
