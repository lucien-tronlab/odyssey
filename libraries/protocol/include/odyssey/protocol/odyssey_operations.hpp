...
namespace odyssey { namespace protocol {
   ...
   {
      FC_ASSERT( permlink.size() < ODYSSEY_MAX_PERMLINK_LENGTH, "permlink is too long" );
    ...
    *  The percent_odyssey_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      uint16_t          percent_odyssey_dollars  = ODYSSEY_100_PERCENT; /// the percent of Odyssey Dollars to key, unkept amounts will be received as Odyssey Power
    ...
    * @ingroup operations
    *
    * @brief Transfers ODYSSEY from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             odyssey_amount = asset( 0, ODYSSEY_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      asset             odyssey_amount = asset( 0, ODYSSEY_SYMBOL ); ///< the amount of odyssey to release
   ...
   /**
    *  This operation converts ODYSSEY into VFS (Vesting Fund Shares) at
    ...
    * vests to odyssey and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in ODYSSEY, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      asset             account_creation_fee =
         asset( ODYSSEY_MIN_ACCOUNT_CREATION_FEE, ODYSSEY_SYMBOL );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = ODYSSEY_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          sbd_interest_rate  = ODYSSEY_DEFAULT_SBD_INTEREST_RATE;

      void validate()const
      {
         FC_ASSERT( account_creation_fee.amount >= ODYSSEY_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= ODYSSEY_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( sbd_interest_rate >= 0 );
         FC_ASSERT( sbd_interest_rate <= ODYSSEY_100_PERCENT );
      }
   };
    ...
    *  used to define the exchange rate between odyssey and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between ODYSSEY and SBD,
    *  The funds are deposited after ODYSSEY_CONVERSION_DELAY
    */
    ...
    * ODYSSEY_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting odyssey.
    *
    * The result of the operation is to transfer the full VESTING ODYSSEY balance
...
FC_REFLECT( odyssey::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( odyssey::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( odyssey::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( odyssey::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( odyssey::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( odyssey::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( odyssey::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( odyssey::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( odyssey::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( odyssey::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( odyssey::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( odyssey::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( odyssey::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(sbd_interest_rate) );

FC_REFLECT_TYPENAME( odyssey::protocol::pow2_work )
FC_REFLECT( odyssey::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( odyssey::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( odyssey::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( odyssey::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( odyssey::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( odyssey::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( odyssey::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( odyssey::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( odyssey::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( odyssey::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( odyssey::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( odyssey::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( odyssey::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( odyssey::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( odyssey::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( odyssey::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( odyssey::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( odyssey::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( odyssey::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( odyssey::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( odyssey::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( odyssey::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( odyssey::protocol::comment_payout_beneficiaries, (beneficiaries) )
FC_REFLECT_TYPENAME( odyssey::protocol::comment_options_extension )
FC_REFLECT( odyssey::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_odyssey_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( odyssey::protocol::escrow_transfer_operation, (from)(to)(sbd_amount)(odyssey_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( odyssey::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( odyssey::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( odyssey::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(odyssey_amount) );
FC_REFLECT( odyssey::protocol::challenge_authority_operation, (challenger)(challenged)(require_owner) );
FC_REFLECT( odyssey::protocol::prove_authority_operation, (challenged)(require_owner) );
FC_REFLECT( odyssey::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( odyssey::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( odyssey::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( odyssey::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( odyssey::protocol::claim_reward_balance_operation, (account)(reward_odyssey)(reward_sbd)(reward_vests) )
FC_REFLECT( odyssey::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
