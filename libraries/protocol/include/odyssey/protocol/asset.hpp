...
namespace odyssey { namespace protocol {
   ...
   struct asset
   {
      asset( share_type a = 0, asset_symbol_type id = ODYSSEY_SYMBOL )
      :amount(a),symbol(id){}
...
namespace fc {
    inline void to_variant( const odyssey::protocol::asset& var,  fc::variant& vo ) { vo = var.to_string(); }
    inline void from_variant( const fc::variant& var,  odyssey::protocol::asset& vo ) { vo = odyssey::protocol::asset::from_string( var.as_string() ); }
}

FC_REFLECT( odyssey::protocol::asset, (amount)(symbol) )
FC_REFLECT( odyssey::protocol::price, (base)(quote) )
