...
/*
 * This class represents the basic versioning scheme of the Odyssey blockchain.
...
{
   class variant;
   void to_variant( const odyssey::protocol::version& v, variant& var );
   void from_variant( const variant& var, odyssey::protocol::version& v );

   void to_variant( const odyssey::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, odyssey::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( odyssey::protocol::version, (v_num) )
FC_REFLECT_DERIVED( odyssey::protocol::hardfork_version, (odyssey::protocol::version), )

FC_REFLECT( odyssey::protocol::hardfork_version_vote, (hf_version)(hf_time) )
