 ...
 * - Length is between (inclusive) ODYSSEY_MIN_ACCOUNT_NAME_LENGTH and ODYSSEY_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace odyssey::protocol


FC_REFLECT_TYPENAME( odyssey::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( odyssey::protocol::authority::key_authority_map)
FC_REFLECT( odyssey::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( odyssey::protocol::authority::classification, (owner)(active)(key)(posting) )
