...
namespace odyssey { namespace protocol {
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = ODYSSEY_MAX_SIG_CHECK_DEPTH
         )const;
      ...
      void verify_authority(
         ...
         const authority_getter& get_owner,
         const authority_getter& get_posting,
         uint32_t max_recursion = ODYSSEY_MAX_SIG_CHECK_DEPTH )const;
...
FC_REFLECT( odyssey::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( odyssey::protocol::signed_transaction, (odyssey::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( odyssey::protocol::annotated_signed_transaction, (odyssey::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
