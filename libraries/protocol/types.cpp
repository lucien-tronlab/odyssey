...
namespace odyssey { namespace protocol {
    ...
    public_key_type::public_key_type( const std::string& base58str )
    {
      ...
      //        to make public_key_type API more similar to address API
       std::string prefix( ODYSSEY_ADDRESS_PREFIX );
    ...
    public_key_type::operator std::string() const
    {
       ...
       return ODYSSEY_ADDRESS_PREFIX + fc::to_base58( data.data(), data.size() );
    }
...
namespace fc
{
    ...
    {
        vo = odyssey::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = odyssey::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = odyssey::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
