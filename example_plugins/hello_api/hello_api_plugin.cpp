...
namespace odyssey { namespace example_plugin {

class hello_api_plugin : public odyssey::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( odyssey::app::application* app );
...
{
   public:
      hello_api_api( const odyssey::app::api_context& ctx );
...
FC_API( odyssey::example_plugin::hello_api_api,
   (get_message)
   )

namespace odyssey { namespace example_plugin {

hello_api_plugin::hello_api_plugin( odyssey::app::application* app ) : odyssey::app::plugin(app) {}
...
hello_api_api::hello_api_api( const odyssey::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The ODYSSEY_DEFINE_PLUGIN() macro will define a odyssey::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

ODYSSEY_DEFINE_PLUGIN( hello_api, odyssey::example_plugin::hello_api_plugin )
