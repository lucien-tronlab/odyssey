...
#include <odyssey/manifest/plugins.hpp>
...
int main(int argc, char** argv) {
   odyssey::plugin::initialize_plugin_factories();
   ...
   try {
      ...
      std::cerr << "------------------------------------------------------\n";
      auto initminer_private_key = graphene::utilities::key_to_wif( ODYSSEY_INIT_PRIVATE_KEY );
      std::cerr << "initminer public key: " << ODYSSEY_INIT_PUBLIC_KEY_STR << "\n";
      std::cerr << "initminer private key: " << initminer_private_key << "\n";
      std::cerr << "chain id: " << std::string(ODYSSEY_CHAIN_ID) << "\n";
      std::cerr << "blockchain version: " << fc::string( ODYSSEY_BLOCKCHAIN_VERSION ) << "\n";
      std::cerr << "------------------------------------------------------\n";
#else
      std::cerr << "------------------------------------------------------\n\n";
      std::cerr << "            STARTING ODYSSEY NETWORK\n\n";
      std::cerr << "------------------------------------------------------\n";
      std::cerr << "initminer public key: " << ODYSSEY_INIT_PUBLIC_KEY_STR << "\n";
      std::cerr << "chain id: " << std::string(ODYSSEY_CHAIN_ID) << "\n";
      std::cerr << "blockchain version: " << fc::string( ODYSSEY_BLOCKCHAIN_VERSION ) << "\n";
      ...
      bpo::options_description app_options("Odyssey Daemon");
      bpo::options_description cfg_options("Odyssey Daemon");
      app_options.add_options()
            ("help,h", "Print this help message and exit.")
            ("data-dir,d", bpo::value<boost::filesystem::path>()->default_value("witness_node_data_dir"), "Directory containing databases, configuration file, etc.")
            ("version,v", "Print odysseyd version and exit.")
            ;

      bpo::variables_map options;

      for( const std::string& plugin_name : odyssey::plugin::get_available_plugins() )
         node->register_abstract_plugin( odyssey::plugin::create_plugin( plugin_name, node ) );
      ...
      {
         std::cout << "odyssey_blockchain_version: " << fc::string( ODYSSEY_BLOCKCHAIN_VERSION ) << "\n";
         std::cout << "odyssey_git_revision:       " << fc::string( graphene::utilities::git_revision_sha ) << "\n";
